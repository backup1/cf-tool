...
你可以从[这里](https://github.com/backup1/cf-tool/releases)直接下载一个可执行文件，直接用就好啦。
...
模板内的脚本:
  ...
  $%path%$   代码的路径 (不包括 $%full%$， 比如 "/home/backup1/")
 ...
 * You can download the binary file in here https://github.com/backup1/cf-tool
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
